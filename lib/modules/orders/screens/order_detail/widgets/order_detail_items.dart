...
class OrderDetailScreenOrderItems extends StatelessWidget {
  ...
  const OrderDetailScreenOrderItems({Key? key, required this.orderItems})
      : super(key: key);
                            ...
                            if (orderItem.selectedAddonCats.length > 0)
                              ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final addonCat =
                                        orderItem.selectedAddonCats[index];
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        ListView.builder(
                                            ...
                                            itemCount:
                                                addonCat.selectedOptions.length,
                                            itemBuilder: (context, index) {
                                              final addonOpt = addonCat
                                              ...
                                              return Row(
                                                ...
                                                children: [
                                                  Text(
                                                      "    + ${addonOpt.name}"),
                                                  Text(
                                                      "${CUR_CURRENCY} ${addonOpt.price.toStringAsFixed(2)}"),
                                                ],
                                              );
                                            })
                                      ],
